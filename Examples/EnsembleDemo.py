...
'''
model1 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=6, nbFilters=32, earlystopping=True, patience=20, filtersize=3, epochs=200)
model2 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=6, nbFilters=64, earlystopping=True, patience=20, filtersize=3, epochs=200)
model3 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=6, nbFilters=128, earlystopping=True, patience=20, filtersize=3, epochs=200)
model4 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=6, nbFilters=150, earlystopping=True, patience=20, filtersize=3, epochs=200)

model5 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=8, nbFilters=32, earlystopping=True, patience=20, filtersize=3, epochs=200)
model6 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=8, nbFilters=64, earlystopping=True, patience=20, filtersize=3, epochs=200)
model7 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=8, nbFilters=128, earlystopping=True, patience=20, filtersize=3, epochs=200)
model8 = RCNN.makeModel(Chans, Length, nbClasses, nbRCL=8, nbFilters=150, earlystopping=True, patience=10, filtersize=3)
